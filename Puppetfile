...
# because we needed changes earlier, and, due to a simp-adapter
# bug WRT RPM upgrades with name changes, can't revert back
# to camptocamp/systemd.  We will revert when we redesign module
...
mod 'puppetlabs-translate',
  # FIXME LATER:  Can't use latest version, because puppetlabs-docker 1.1.0
